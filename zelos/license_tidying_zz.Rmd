...
counts_df <- license_df %>%
  select(RowNumber, BreedName, ZipCode, Borough, cleaned_borough, supposed_borough, LicenseIssuedDate, LicenseExpiredDate, issued_year, expired_year)
...
write.csv(agreed_df, file = "agreed_boroughs_license_df.csv", row.names = FALSE)
```
