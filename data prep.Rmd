...
zipcode = zipcode %>%
  mutate(city = tolower(city),
         borough = ifelse(city %in% c('new york', 'manhattan'), 'New York', NA),
  ...
  filter(borough %in% c('New York', 'Bronx', 'Brooklyn', 'Queens', 'Staten Island') & state == 'NY')
...
agree_ids <- counts_df$RowNumber[which(counts_df$cleaned_borough == counts_df$final_borough)]
...
# write.csv(agreed_df, './data/cleaned_license_data.csv')
```
